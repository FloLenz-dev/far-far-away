...
fun calculateLandpoints(
    ...
    val file = File("is_land83.00000000000006.save")
    val bytes = file.readBytes()
    val isLandMap: Map<String, Boolean> =
        cborMapper.readValue(bytes, object : com.fasterxml.jackson.core.type.TypeReference<Map<String, Boolean>>() {})

    println(isLandMap.keys)
    ...
    while (lat >= -63.0) { //don't look at antarctica
        ...
        while (lon <= 180.0) {
            ...
            if (!(isLandMap.containsKey(current)))
            {
